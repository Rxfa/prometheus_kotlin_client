...
mavenPublishing {
    ...
    coordinates(group.toString(), "prometheus-http", version.toString())

    pom {
        name = "Prometheus HTTP"
        description = "A lightweight HTTP server implementation for exposing Prometheus-compatible metrics."
        inceptionYear = "2025"
