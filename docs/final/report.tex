...
\usepackage{listings}
\usepackage{xcolor}
\usepackage[colorlinks=true, urlcolor=blue]{hyperref} % for clickable links


% Define Kotlin language for listings
\lstdefinelanguage{Kotlin}{
  morekeywords={fun, val, var, if, else, when, return, null, true, false},
  sensitive=true,
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]"
...
% Geração do índice de figuras e de tabelas
    ...
    \input{acronyms} \cleardoublepage
