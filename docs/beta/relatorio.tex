...
% Geração do índice de figuras e de tabelas
    ...
    \input{/home/rxfa/Desktop/school/PS/docs/beta/acronyms} \cleardoublepage

% Chapter 1
    \include{/home/rxfa/Desktop/school/PS/docs/beta/introduction}

% Chapter 2
    \include{/home/rxfa/Desktop/school/PS/docs/beta/background}

% Chapter 3
    \include{/home/rxfa/Desktop/school/PS/docs/beta/problem}

% Chapter 4
    \include{/home/rxfa/Desktop/school/PS/docs/beta/architecture}

% Chapter 5
    \include{/home/rxfa/Desktop/school/PS/docs/beta/implementation}

% Chapter 6
    \include{/home/rxfa/Desktop/school/PS/docs/beta/evaluation}

% Chapter 7
    \include{/home/rxfa/Desktop/school/PS/docs/beta/future}

% Chapter 8
    \include{/home/rxfa/Desktop/school/PS/docs/beta/conclusion}

% References
    \bibliographystyle{plain}
    \bibliography{/home/rxfa/Desktop/school/PS/docs/beta/refs}
    \addcontentsline{toc}{chapter}{References}

    \appendix
    \include{/home/rxfa/Desktop/school/PS/docs/beta/appendix}
